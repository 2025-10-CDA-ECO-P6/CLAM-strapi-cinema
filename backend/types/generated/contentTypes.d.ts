...
export interface ApiActorActor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    db_id: Schema.Attribute.BigInteger & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMovieMovie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    directors: Schema.Attribute.Relation<
      ...
      'api::director.director'
    >;
    favorite: Schema.Attribute.Relation<'manyToOne', 'api::favorite.favorite'>;
    ...
    vote_count: Schema.Attribute.BigInteger;
  };
}
